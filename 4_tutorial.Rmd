...
The following software will be needed to complete this tutorial:  

1. [R environment](https://www.r-project.org/),  
2. [ArcGIS](https://www.esri.com/) or [QGIS](https://www.qgis.org/) (optional to view results), and  
3. [RStudio](https://rstudio.com/) (optional).

The following pre-requisite skills will be helpful:  

1. R programming language
    - install and load packages
    - load and manipulate data
    - use R functions and objects
